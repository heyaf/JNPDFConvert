...
//  unitAircraft
//
//  Created by YAMYEE on 2019/3/27.
//  Copyright © 2019年 YAMYEE. All rights reserved.
//
...
public class ProgressHUD: NSObject {
    ...
    ///loding动画视图
//    public static var loadingView : AnimationView {
//        let filepath = (Bundle(for: ProgressHUD.self).resourcePath ?? "") + kBundleJSONSourcePath + "/progress.json"
//
//        var animationView = AnimationView(filePath: filepath)
//        animationView.contentMode = .scaleAspectFit
//        animationView.transform = CGAffineTransform(scaleX: 0.45, y: 0.45)
...
//    }
    ...
    static func createHUD(for view:UIView)->MBProgressHUD{
        ...
        hud.label.font = UIFont(name: "Nunito-Bold", size: 17)
...
extension ProgressHUD{
    ...
    public func showProgressHUD(type:HUDType ,status:String?=nil,view:UIView?,delay:TimeInterval?){
        DispatchQueue.safeMainAsync {
            ...
            guard let currentView = view ?? currentWindow() else{
                return
            }
            ...
            case .message,.error,.success:
                ...
                hud.customView = nil
                hud.mode = .text
                hud.bezelView.color = .hex("#323334")
